...
Ans6. The outcome obtained in question 2  as per probability method was 0.08955224, while in question 5, using Naive Bayes the probability is 0.09362709.
Given this comparison, 0.08955224 is deemed more accurate, as Naive Bayes demonstrates a slight deviation from the actual value. This discrepancy arises because Naive Bayes assumes independence among all events.
...
```
The value obtained in Question 7 is 0.09842652, while the figure from Question 5 is 0.09362709. The results are nearly identical, with the slight difference. This discrepancy is negligible and does not impact the ranking order of the outcomes.
